...
* ### 제2부: 나노 소재와 트랜지스터 구조
  * #### [FinFET의 물리적 임계점](#21)
  * #### [GAA(Gate-All-Around)](#22)
  * #### [MBCFET 아키텍처](#23)
  * #### [High-k 메탈 게이트](#24)
  * #### [BSPD(후면 전력 공급)](#25)
  * #### [CFET(Complementary FET)](#26)
...
* 물리적 정의와 공식
  ...
  * $E = k_{B} Tln2$
    ...
    * ​$\ln 2$ (2의 자연로그): 정보가 2가지 상태(0, 1)에서 1가지 상태로 줄어드는 비율을 의미한다.
...
[ TMI ]
* KAIST 연구팀, 차세대 소자 개발의 핵심 '물리 표준이론' 대안 제시 [(기사보러가기)](https://www.kaist.ac.kr/news/html/news/?mode=V&mng_no=9010) [자료내용 요약본 보러가기](CPU/thesis/KAIST/랜다우어 한계.md)
